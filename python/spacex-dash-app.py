...
# TASK 2: Callback for updating pie chart based on dropdown
@app.callback(
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        fig = px.pie(
            spacex_df, 
            names='Launch Site', 
            values='class',  # counts of success launches
...
# TASK 4: Callback for updating scatter plot based on dropdown and payload slider
@app.callback(
